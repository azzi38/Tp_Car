...
<body>
	...
	<tbody>
			<tr class="active-row">
					<td>Nom:</td>
					<td class="absorbing-column">${user.nomClient} </td>
			</tr>
			<tr class="active-row">
					<td>Prenom:</td>
					<td class="absorbing-column">${user.prenom}  </td>
			</tr>
			<tr class="active-row">
					<td >Email:</td>
			...
			<tr class="active-row">
					...
					<td class="absorbing-column">${user.tel}  </td>
			</tr>
			<tr class="active-row">
					<td>Adresse:</td>
					<td class="absorbing-column">${user.adress} </td>
			</tr>
	</tbody>

</table>
<br>
					<fieldset><legend>Mes Commandes:</legend>
    ...
    <tbody>
			<c:forEach items="${com.lignes}" var="ligne">
        <tr >
						<td><img src="../img/${ligne.nomProduit}.jpg" style="width: 50px; height: 50px;"></td>
            <td>${ligne.nomProduit} </td>
            <td>${ligne.prix} &#8364</td>
        </tr>
    </tbody>
			</c:forEach>
</table>
